...
<div class="main-subhead">
	<h2 class="hn"><span><?php echo forum_htmlencode($forum_page['question']) ?> </span></h2>
</div>
<div class="main-content main-frm">
	<form id="afocus" class="frm-form" method="post" accept-charset="utf-8" action="<?php echo forum_htmlencode($forum_page['form_handler']) ?>">
		<div class="hidden">
